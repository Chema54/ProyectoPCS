 ...
 * @author josem
 */
public class CoordinatorMenuFXMLController implements Initializable {

    /**
     * Initializes the controller class.
     */
    private static final Logger LOGGER = LogManager.getLogger(CoordinatorMenuFXMLController.class);
    ...
    private void loadSelectedView(Toggle toggle) throws UserDisplayableException {
        if (toggle == toggleButtonProject) {
            ...
            changeSubView("/main/application/views/coordinator/ProjectFXML.fxml");
        } else if (toggle == toggleButtonPeriod) {
            System.out.println("Cargando vista de periodos...");
            changeSubView("/main/application/views/coordinator/PeriodFXML.fxml");
        } else if (toggle == toggleButtonUsers) {
            System.out.println("Cargando vista de usuarios...");
            changeSubView("/main/application/views/coordinator/UserFXML.fxml");
        } else if (toggle == toggleButtonAcceptanceDocuments) {
            System.out.println("Cargando vista de usuarios...");
            changeSubView("/main/application/views/coordinator/AcceptanceFXML.fxml");
        }
    }
