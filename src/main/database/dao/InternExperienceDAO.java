...
import main.business.dto.InternExperienceDTO;
...
public class InternExperienceDAO extends CompleteDAOShape<InternExperienceDTO, String> {

    private static final Logger LOGGER = LogManager.getLogger(InternExperienceDAO.class);
    ...
    @Override
    public void createOne(InternExperienceDTO dto) throws UserDisplayableException {
        try (
    ...
    @Override
    public List<InternExperienceDTO> getAll() throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
            PreparedStatement statement = connection.prepareStatement(GET_ALL_QUERY);
            ResultSet resultSet = statement.executeQuery()
        ) {
            List<InternExperienceDTO> list = new ArrayList<>();
    ...
    @Override
    public InternExperienceDTO getOne(String idCompuesto) throws UserDisplayableException {
        throw new UnsupportedOperationException("Método getOne no soportado para llaves compuestas en este DAO.");
    }

    @Override
    public void updateOne(InternExperienceDTO dto) throws UserDisplayableException {
    ...
    private InternExperienceDTO mapResultSetToDTO(ResultSet resultSet) throws SQLException {
        return new InternExperienceDTO.InternExperienceBuilder()
