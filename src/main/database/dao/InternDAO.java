...
public class InternDAO extends CompleteDAOShape<InternDTO, Integer> {

    private static final Logger LOGGER = LogManager.getLogger(InternDAO.class);
    ...
    @Override
    public void createOne(InternDTO internDTO) throws UserDisplayableException {
        try (
    ...
    public int createOneAndReturnId(InternDTO internDTO) throws UserDisplayableException {
        int generatedId = -1;
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    @Override
    public List<InternDTO> getAll() throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    @Override
    public InternDTO getOne(Integer id) throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    @Override
    public void updateOne(InternDTO internDTO) throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    public InternDTO getByEnrollment(String enrollment) throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
            ...
            throw ExceptionHandler.handleSQLException(LOGGER, e, "Error obteniendo el practicante.");
        }
        return null;
    }

    private InternDTO mapResultSetToDTO(ResultSet resultSet) throws SQLException {
        return new InternDTO.InternBuilder()
