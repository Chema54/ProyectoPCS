...
public class AssignmentDAO extends CompleteDAOShape<AssignmentDTO, Integer> {
    ...
    @Override
    public void createOne(AssignmentDTO assignmentDTO) throws UserDisplayableException {
        try (
    ...
    public int createOneAndReturnId(AssignmentDTO assignmentDTO) throws UserDisplayableException {
        int generatedId = -1;
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    @Override
    public List<AssignmentDTO> getAll() throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    @Override
    public AssignmentDTO getOne(Integer id) throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    @Override
    public void updateOne(AssignmentDTO assignmentDTO) throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    public AssignmentDTO getActiveAssignmentByIntern(int internId) throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
            ...
            throw ExceptionHandler.handleSQLException(LOGGER, e, "Error obteniendo la asignación activa.");
        }
        return null;
    }

    private AssignmentDTO mapResultSetToDTO(ResultSet resultSet) throws SQLException {
        return new AssignmentDTO.AssignmentBuilder()
