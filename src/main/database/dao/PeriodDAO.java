...
public class PeriodDAO extends CompleteDAOShape<PeriodDTO, Integer> {
    ...
    @Override
    public void createOne(PeriodDTO periodDTO) throws UserDisplayableException {
        createAndReturnId(periodDTO);
    }

    public Integer createAndReturnId(PeriodDTO periodDTO) throws UserDisplayableException {
        try (
    ...
    @Override
    public List<PeriodDTO> getAll() throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    @Override
    public PeriodDTO getOne(Integer id) throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    @Override
    public void updateOne(PeriodDTO periodDTO) throws UserDisplayableException {
        try (
            Connection connection = DBConnector.getInstance().getConnection();
    ...
    private PeriodDTO mapResultSetToDTO(ResultSet resultSet) throws SQLException {
        return new PeriodDTO.PeriodBuilder()
